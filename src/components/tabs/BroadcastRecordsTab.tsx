              ...
              <table className="custom-table">
                <thead>
                  <tr>
                    ...
                    <th>Broadcast ID</th>
                    <th style={{ width: 112 }}>Type</th>
                    <th style={{ width: 56 }}>Level</th>
                    <th>Incident / Case</th>
                    <th style={{ width: 180 }}>Recipients</th>
                    <th style={{ width: 64 }}>Channel</th>
                  ...
                  {data.map((b) => {
                    ...
                    return (
                      <tr key={b.id} onClick={() => setDrawerId(b.id)} style={{ cursor: 'pointer' }}>
                        ...
                        <td><LevelDot level={b.crisisLevel} /></td>
                        <td>
                        ...
                        <td><ChannelIcons channels={b.channels} /></td>
                        <td>
                          <StatusBadge bc={b} />
                          {delivery && (
