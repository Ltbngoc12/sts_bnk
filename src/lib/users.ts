...
export const DEFAULT_USERS: UserAccount[] = [
  ...
  { id: '10', name: 'Ranger Dave', email: 'dave.doe@ranger.com.sg', department: 'Security & Ranger Service', orgUnit: 'Siloso Beach Patrol', authSource: 'Non-SSO', role: 'Responder', status: 'Active', lastLogin: 'Never' },
  { id: '11', name: 'Ranger Sarah', email: 'sarah.doe@ranger.com.sg', department: 'Security & Ranger Service', orgUnit: 'Siloso Beach Patrol', authSource: 'Non-SSO', role: 'Responder', status: 'Active', lastLogin: 'Never' },
  { id: '12', name: 'Ranger Mike', email: 'mike.doe@ranger.com.sg', department: 'Security & Ranger Service', orgUnit: 'Siloso Beach Patrol', authSource: 'Non-SSO', role: 'Responder', status: 'Active', lastLogin: 'Never' },
  { id: '13', name: 'Ranger Alex', email: 'alex.doe@ranger.com.sg', department: 'Security & Ranger Service', orgUnit: 'Siloso Beach Patrol', authSource: 'Non-SSO', role: 'Responder', status: 'Active', lastLogin: 'Never' },
  { id: '14', name: 'Ranger Tommy', email: 'tommy.doe@ranger.com.sg', department: 'Security & Ranger Service', orgUnit: 'Siloso Beach Patrol', authSource: 'Non-SSO', role: 'Responder', status: 'Active', lastLogin: 'Never' }
];
