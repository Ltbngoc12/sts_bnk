...
const DEFAULT_ROLES: RoleDefinition[] = [
  ...
  { id: 'broadcast-recipient', name: 'Broadcast Recipient', description: 'External and internal contact groups receiving dispatch templates.', scope: 'None (Receives SMS/Email only)', modules: ['Broadcast Notifications'], status: 'Active', isSystem: true },
