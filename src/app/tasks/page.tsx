    ...
    <>
      ...
      <div className="cases-header-bar glass">
        <div className="title-section">
          <h1 style={{ textTransform: 'uppercase' }}>Task Management Board</h1>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px', borderBottom: '1px solid var(--border-color)', paddingBottom: '12px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap', flexGrow: 1, justifyContent: 'flex-end' }}>
            ...
            <button
              ...
              style={{ padding: '0 14px', fontSize: '12.5px', height: '36px', display: 'flex', alignItems: 'center', gap: '8px', whiteSpace: 'nowrap', fontWeight: 600, borderRadius: 'var(--radius-md)' }}
            >
              <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <style jsx>{`
        ...
        .attach-draft { display: flex; flex-wrap: wrap; gap: 8px; margin-top: 6px; font-size: 11.5px; color: var(--text-muted); }
